...
{
    public partial class AddExpenses :TemplateForm //MetroTemplate
    {
        public AddExpenses()
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (isValid())
            {
                ...
                {
                    string query = "Insert into tblDailySheet(Title,Expense,Note,date) Values('" + txtTitle.Text.Trim() + "','" + txtAmount.Text.Trim() + "','"+txtDesc.Text.Trim()+"',@date)";
